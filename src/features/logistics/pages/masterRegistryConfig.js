...
export const FORMS = {
  ...
  priceTables:{ initial:{code:"",name:"",clientId:"",contractId:"",productId:"",currency:"BRL",validFrom:"",validUntil:"",adjustmentIndex:"",documentUrl:"",status:"draft"}, fields:[["code","Código"],["name","Nome da tabela","text",true],["clientId","ID do cliente, quando específica"],["contractId","ID do contrato, quando específico"],["productId","Produto logístico"],["currency","Moeda"],["validFrom","Vigência inicial","date"],["validUntil","Vigência final","date"],["adjustmentIndex","Índice de reajuste"],["documentUrl","Arquivo da tabela — link do OneDrive, Drive ou URL (.xlsx, .pdf, .csv...)"],["status","Status","select",false,"priceStatus"]] },
