...
export const FORMS = {
  ...
  drivers:{ initial:{driverCode:"",fullName:"",document:"",employmentType:"employee",phone:"",email:"",operationalUnitId:"",baseName:"",availabilityStatus:"unavailable",cnhNumber:"",cnhCategory:"",cnhExpiresAt:"",moppExpiresAt:"",rntrc:"",status:"draft"}, fields:[["driverCode","Código"],["fullName","Nome completo","text",true],["document","CPF / CNPJ"],["employmentType","Vínculo","select",false,"driverEmployment"],["phone","Telefone"],["email","E-mail","email"],["operationalUnitId","ID da base / unidade"],["baseName","Base de referência"],["availabilityStatus","Disponibilidade","select",false,"driverAvailability"],["cnhNumber","CNH"],["cnhCategory","Categoria CNH"],["cnhExpiresAt","Validade CNH","date"],["moppExpiresAt","Validade MOPP","date"],["rntrc","RNTRC, quando aplicável"],["status","Status cadastral","select",false,"driverStatus"]] },
  ...
  priceTables:{ initial:{code:"",name:"",clientId:"",contractId:"",productId:"",currency:"BRL",validFrom:"",validUntil:"",adjustmentIndex:"",status:"draft"}, fields:[["code","Código"],["name","Nome da tabela","text",true],["clientId","ID do cliente, quando específica"],["contractId","ID do contrato, quando específico"],["productId","Produto logístico"],["currency","Moeda"],["validFrom","Vigência inicial","date"],["validUntil","Vigência final","date"],["adjustmentIndex","Índice de reajuste"],["status","Status","select",false,"priceStatus"]] },
...
export const rowFor = (tab,r) => {
  ...
  if(tab==="priceTables") return [r.code||"—",r.name,r.productId||"—",`${date(r.validFrom)} a ${date(r.validUntil)}`,r.status];
